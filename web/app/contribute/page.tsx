  ...
  return (
    <main id="main" className="prose-page">
      ...
      <section>
        ...
        <p>When the notice specifies AI screening, submitting sends the contribution to Jev through Vercel and publishes it automatically if it passes. Screening is not human review or proof that an answer is correct. Only contribute material you have permission to share, after removing secrets and personal information. Your API key is never included.</p>
        <p>Pending submissions expire after 30 days; your receipt shows the exact expiration time. Published cases may remain longer. Withdrawal cannot recall someone else’s copy, fork or archive; contact the operator privately about published material.</p>
        <p>The separate “Share this experiment” private-research form remains opt-in and does not authorize publication. Existing private submissions stay private. Older public submissions are not automatically screened or published: only the new automated-review consent authorizes later Vercel/Jev screening. No contribution path authorizes model training or unrelated provider calls. When automated review is disabled, public submissions stay in the existing review queue.</p>
